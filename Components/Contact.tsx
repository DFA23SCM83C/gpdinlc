    ...
    return (
        ...
        >
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
                    ...
                    Please contact us if you want to know about the details
                ...
                <ul className="my-4 space-y-2">
                    <li>
                        ...
                        <a
                            ...
                            href="https://www.facebook.com/gpdinewlifechicago/"
                        >
                    ...
                    <li>
                        <a
                            className="group flex items-center rounded-lg bg-gray-50 p-3 text-base font-bold text-gray-900 hover:bg-gray-100 hover:shadow dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500"
                            href="https://www.instagram.com/gpdi_chicago/?hl=en"
                        >
                    ...
                    <li>
                        <a
                            className="group flex items-center rounded-lg bg-gray-50 p-3 text-base font-bold text-gray-900 hover:bg-gray-100 hover:shadow dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500"
                            href="https://www.youtube.com/channel/UCOuOmkarpVF5tsFeuvyd0fg"
                        >
